...
public class CrystalHeaderFragment extends LinearLayout implements OnPagedViewChangeListener {
		...
		public void onItemClick(View view, JSONObject item) {
			...
			try {
				...
				if(!id.equals(selected)){					
					...
					CrystalButton crystalButton = (CrystalButton) view.findViewById(R.id.header_fragment_gridview_item_cr1);
