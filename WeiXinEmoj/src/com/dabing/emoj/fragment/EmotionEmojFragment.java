...
import com.dabing.emoj.fragment.CommonEmojFragment.EmojRequest;
...
public class EmotionEmojFragment extends BaseEmojFragment implements IUMengReceiveListener,OnItemClickListener,OnScrollListener {
	...
	static final String TAG = EmotionEmojFragment.class.getSimpleName();
	public EmotionEmojFragment(){
		this(null);
	}
	public EmotionEmojFragment(JSONObject obj) {
		super(obj);
		// TODO Auto-generated constructor stub
	}

	public static BaseEmojFragment getInstance(JSONObject obj){
		BaseEmojFragment fragment = new EmotionEmojFragment(obj);
		return fragment;
	}
	/* (non-Javadoc)
