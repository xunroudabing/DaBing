...
public class UserDefineDataBaseHelper  extends SQLiteOpenHelper{
	...
	static final String FIELD_STATE = "state";//状态位
	...
	public UserDefineCursor getCursor(){
		...
		UserDefineCursor cursor = (UserDefineCursor) db.rawQueryWithFactory(new UserDefineCursor.Factory(), query, null, null);
		cursor.moveToFirst();
		return cursor;
	}
